...
public class HummingbirdAgent : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        // Default to spawning in front of a flower (To balance out the spawning area between infront of a flower and not)
    ...
    // Index 0: move vector x (+1 = right , -1 = left , 0 nor left or right)
    ...
    {
        //If nearestFlower is null , observe an empty and return early
        ...
        // Observe a dot product that indicates whether the beak tip is infront of the flower. (1 observation)
    ...
    private void MoveToSafeRandomPosition(bool inFrontOfFlower)
    {
        ...
        while(!safePositionFound && attemptsRemaining > 0)
        {
            ...
            if (inFrontOfFlower)
            {
                ...
                //Position 10 to 20 cm infront of the flower
    ...
    if (collider.CompareTag("nectar"))
    {
        ...
        // Check if the closest collision is close to the beak tip
        // Note: a collision with anything other than the beak tip should not count.
        if (Vector3.Distance(beakTip.position , closestPointToBeakTip)< BeakTipRadius)
        {
           ...
           // Note: This is per fixed timestep, meaning it happens every 0.2 seconds, or 50x per second.
     ...
     private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            //Collided within the area boundary, give a negative reward
            AddReward(-.5f);
        }    
    }
    /// <summary>
    ...
    {
        // Avoids scenario where the nearest flower is stolen by opponent and not updated
